...
namespace Michsky.MUIP
{
    ...
    public class ProgressBarEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var onMaxValueReached = serializedObject.FindProperty("onMaxValueReached");
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    EditorGUILayout.PropertyField(onMaxValueReached, new GUIContent("On Max Value Reached"));
                    break;
